...
layout(set = 1, binding = 2) uniform mediump textureCubeArrayFix radiance_cubemap;
...
layout(set = 1, binding = 3) uniform mediump textureCubeArrayFix reflection_atlas;

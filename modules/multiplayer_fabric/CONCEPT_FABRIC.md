...
synchronizer). CH_INTEREST (1), CH_PLAYER (2), and CH_MIGRATION (3)
carry Fabric-specific streams. Neither side inspects the other's
...
400-slot `MIGRATION_HEADROOM` reserve absorbs the burst.

...
`u_voxel_lod_info`                      | `int`        | Will be assigned to a combination of the LOD index of the block and the total number of LODs. Layout: `000000 000000 cccccccc iiiiiiii` where `c` is LOD count and `i` is LOD index. Mainly intended for debugging.

...
TEST_SUITE("[Modules][DirectDeltaMush][MatrixOperations]") {
	...
	TEST_CASE("[MatrixOperations] Matrix decomposition - scale only") {
		...
		Matrix3 M;
		M.m[0][0] = 2.0f; M.m[0][1] = 0.0f; M.m[0][2] = 0.0f;
		M.m[1][0] = 0.0f; M.m[1][1] = 3.0f; M.m[1][2] = 0.0f;
		M.m[2][0] = 0.0f; M.m[2][1] = 0.0f; M.m[2][2] = 4.0f;
	...
	TEST_CASE("[MatrixOperations] Matrix decomposition - rotation + scale") {
		...
		// Add scale
		Matrix3 S;
		S.m[0][0] = 2.0f; S.m[1][1] = 2.0f; S.m[2][2] = 2.0f;
	...
	TEST_CASE("[MatrixOperations] Polar decomposition - rotation + scale") {
		...
		Matrix3 M;
		M.m[0][0] = c * scale;  M.m[0][1] = -s * scale; M.m[0][2] = 0;
		M.m[1][0] = s * scale;  M.m[1][1] = c * scale;  M.m[1][2] = 0;
		M.m[2][0] = 0;          M.m[2][1] = 0;          M.m[2][2] = scale;
	...
	TEST_CASE("[MatrixOperations] Reorthogonalization") {
		...
		Matrix3 M;
		M.m[0][0] = 1.0f;  M.m[0][1] = 0.01f; M.m[0][2] = 0.0f;
		M.m[1][0] = 0.01f; M.m[1][1] = 1.0f;  M.m[1][2] = 0.0f;
	...
	TEST_CASE("[MatrixOperations] Non-rigid displacement") {
		...
		Matrix3 M_scale;
		M_scale.m[0][0] = 2.0f; M_scale.m[1][1] = 2.0f; M_scale.m[2][2] = 2.0f;

...
static bool ufbx_ascii_write_string(ufbx_ascii_writer *writer, const char *str) {
    ...
    if (!ufbx_ascii_ensure_capacity(writer, len)) return false;
...
static bool ufbx_ascii_write_char(ufbx_ascii_writer *writer, char c) {
    if (!ufbx_ascii_ensure_capacity(writer, 1)) return false;
...
static bool ufbx_ascii_write_indent(ufbx_ascii_writer *writer) {
    for (int i = 0; i < writer->indent_level; i++) {
        if (!ufbx_ascii_write_string(writer, "    ")) return false; // 4 spaces per indent
    }
    return true;
}
...
static bool ufbx_ascii_write_property_string(ufbx_ascii_writer *writer, const char *str) {
    if (!ufbx_ascii_write_char(writer, '"')) return false;
    if (str) {
        // TODO: Escape special characters if needed
        if (!ufbx_ascii_write_string(writer, str)) return false;
    }
    return ufbx_ascii_write_char(writer, '"');
}
...
static bool ufbx_ascii_write_property_array_f64(ufbx_ascii_writer *writer, const double *values, size_t count) {
    ...
    if (!ufbx_ascii_write_string(writer, buffer)) return false;
    if (!ufbx_ascii_write_string(writer, " {\n")) return false;
    
    writer->indent_level++;
    if (!ufbx_ascii_write_indent(writer)) return false;
    if (!ufbx_ascii_write_string(writer, "a: ")) return false;
    
    for (size_t i = 0; i < count; i++) {
        if (i > 0) {
            if (!ufbx_ascii_write_char(writer, ',')) return false;
        }
        if (!ufbx_ascii_write_property_f64(writer, values[i])) return false;
    }
    
    if (!ufbx_ascii_write_newline(writer)) return false;
    writer->indent_level--;
    if (!ufbx_ascii_write_indent(writer)) return false;
    return ufbx_ascii_write_char(writer, '}');
}
...
static bool ufbx_ascii_write_property_array_i32(ufbx_ascii_writer *writer, const int32_t *values, size_t count) {
    ...
    for (size_t i = 0; i < count; i++) {
        ...
        if (!ufbx_ascii_write_property_i64(writer, values[i])) return false;
    }
...
static bool ufbx_ascii_write_node_begin(ufbx_ascii_writer *writer, const char *name) {
    if (!ufbx_ascii_write_indent(writer)) return false;
    if (!ufbx_ascii_write_string(writer, name)) return false;
    if (!ufbx_ascii_write_string(writer, ": ")) return false;
    return true;
}
...
static bool ufbx_ascii_write_header(ufbx_ascii_writer *writer, uint32_t version) {
    ...
    if (!ufbx_ascii_write_string(writer, buffer)) return false;
    if (!ufbx_ascii_write_string(writer, "; Created by ufbx_export\n\n")) return false;
    return true;
}

static bool ufbx_ascii_write_scene_info(ufbx_ascii_writer *writer, const ufbx_export_scene *scene) {
    if (!ufbx_ascii_write_node_begin(writer, "FBXHeaderExtension")) return false;
    if (!ufbx_ascii_write_string(writer, "{\n")) return false;
    writer->indent_level++;
    
    // FBXHeaderVersion
    if (!ufbx_ascii_write_node_begin(writer, "FBXHeaderVersion")) return false;
    if (!ufbx_ascii_write_property_i64(writer, 1003)) return false;
    if (!ufbx_ascii_write_newline(writer)) return false;
    
    // FBXVersion
    if (!ufbx_ascii_write_node_begin(writer, "FBXVersion")) return false;
    if (!ufbx_ascii_write_property_i64(writer, writer->version)) return false;
    if (!ufbx_ascii_write_newline(writer)) return false;
    
    // Creator
    if (!ufbx_ascii_write_node_begin(writer, "Creator")) return false;
    if (!ufbx_ascii_write_property_string(writer, scene->metadata.creator)) return false;
    if (!ufbx_ascii_write_newline(writer)) return false;
...
static bool ufbx_ascii_write_global_settings(ufbx_ascii_writer *writer, const ufbx_export_scene *scene) {
    if (!ufbx_ascii_write_node_begin(writer, "GlobalSettings")) return false;
    if (!ufbx_ascii_write_string(writer, "{\n")) return false;
    writer->indent_level++;
    
    // Version
    if (!ufbx_ascii_write_node_begin(writer, "Version")) return false;
    if (!ufbx_ascii_write_property_i64(writer, 1000)) return false;
    if (!ufbx_ascii_write_newline(writer)) return false;
    
    // Properties70
    if (!ufbx_ascii_write_node_begin(writer, "Properties70")) return false;
    if (!ufbx_ascii_write_string(writer, "{\n")) return false;
    writer->indent_level++;
    
    // UpAxis
    if (!ufbx_ascii_write_node_begin(writer, "P")) return false;
    if (!ufbx_ascii_write_property_string(writer, "UpAxis")) return false;
    if (!ufbx_ascii_write_string(writer, ", ")) return false;
    if (!ufbx_ascii_write_property_string(writer, "int")) return false;
    if (!ufbx_ascii_write_string(writer, ", ")) return false;
    if (!ufbx_ascii_write_property_string(writer, "Integer")) return false;
    if (!ufbx_ascii_write_string(writer, ", ")) return false;
    if (!ufbx_ascii_write_property_string(writer, "")) return false;
    if (!ufbx_ascii_write_string(writer, ", ")) return false;
    if (!ufbx_ascii_write_property_i64(writer, scene->settings.axes.up == UFBX_COORDINATE_AXIS_POSITIVE_Y ? 1 : 2)) return false;
    if (!ufbx_ascii_write_newline(writer)) return false;
    
    // UnitScaleFactor
    if (!ufbx_ascii_write_node_begin(writer, "P")) return false;
    if (!ufbx_ascii_write_property_string(writer, "UnitScaleFactor")) return false;
    if (!ufbx_ascii_write_string(writer, ", ")) return false;
    if (!ufbx_ascii_write_property_string(writer, "double")) return false;
    if (!ufbx_ascii_write_string(writer, ", ")) return false;
    if (!ufbx_ascii_write_property_string(writer, "Number")) return false;
    if (!ufbx_ascii_write_string(writer, ", ")) return false;
    if (!ufbx_ascii_write_property_string(writer, "")) return false;
    if (!ufbx_ascii_write_string(writer, ", ")) return false;
    if (!ufbx_ascii_write_property_f64(writer, scene->settings.unit_meters * 100.0)) return false;
    if (!ufbx_ascii_write_newline(writer)) return false;
    
    writer->indent_level--;
    if (!ufbx_ascii_write_node_end(writer)) return false;
...
static bool ufbx_ascii_write_objects(ufbx_ascii_writer *writer, const ufbx_export_scene *scene) {
    ...
    if (!ufbx_ascii_write_node_begin(writer, "Objects")) return false;
    if (!ufbx_ascii_write_string(writer, "{\n")) return false;
    writer->indent_level++;
    ...
    for (size_t i = 0; i < scene_imp->num_nodes; i++) {
        ...
        if (!ufbx_ascii_write_node_begin(writer, "Model")) return false;
        if (!ufbx_ascii_write_property_i64(writer, node->element.element_id)) return false;
        if (!ufbx_ascii_write_string(writer, ", ")) return false;
        if (!ufbx_ascii_write_property_string(writer, node->element.name.data)) return false;
        if (!ufbx_ascii_write_string(writer, ", ")) return false;
        if (!ufbx_ascii_write_property_string(writer, "Mesh")) return false;
        if (!ufbx_ascii_write_string(writer, " {\n")) return false;
        writer->indent_level++;
        
        // Version
        if (!ufbx_ascii_write_node_begin(writer, "Version")) return false;
        if (!ufbx_ascii_write_property_i64(writer, 232)) return false;
        if (!ufbx_ascii_write_newline(writer)) return false;
        ...
        // Lcl Translation
        if (!ufbx_ascii_write_node_begin(writer, "P")) return false;
        if (!ufbx_ascii_write_property_string(writer, "Lcl Translation")) return false;
        if (!ufbx_ascii_write_string(writer, ", ")) return false;
        if (!ufbx_ascii_write_property_string(writer, "Lcl Translation")) return false;
        if (!ufbx_ascii_write_string(writer, ", ")) return false;
        if (!ufbx_ascii_write_property_string(writer, "")) return false;
        if (!ufbx_ascii_write_string(writer, ", ")) return false;
        if (!ufbx_ascii_write_property_string(writer, "A")) return false;
        if (!ufbx_ascii_write_string(writer, ", ")) return false;
        if (!ufbx_ascii_write_property_f64(writer, node->local_transform.translation.x)) return false;
        if (!ufbx_ascii_write_string(writer, ", ")) return false;
        if (!ufbx_ascii_write_property_f64(writer, node->local_transform.translation.y)) return false;
        if (!ufbx_ascii_write_string(writer, ", ")) return false;
        if (!ufbx_ascii_write_property_f64(writer, node->local_transform.translation.z)) return false;
        if (!ufbx_ascii_write_newline(writer)) return false;
    ...
    for (size_t i = 0; i < scene_imp->num_meshes; i++) {
        ...
        if (!ufbx_ascii_write_node_begin(writer, "Geometry")) return false;
        if (!ufbx_ascii_write_property_i64(writer, mesh->element.element_id)) return false;
        if (!ufbx_ascii_write_string(writer, ", ")) return false;
        if (!ufbx_ascii_write_property_string(writer, mesh->element.name.data)) return false;
        if (!ufbx_ascii_write_string(writer, ", ")) return false;
        if (!ufbx_ascii_write_property_string(writer, "Mesh")) return false;
        if (!ufbx_ascii_write_string(writer, " {\n")) return false;
        writer->indent_level++;
        ...
        if (mesh->vertices.count > 0) {
            if (!ufbx_ascii_write_node_begin(writer, "Vertices")) return false;
        ...
        if (mesh->vertex_indices.count > 0) {
            if (!ufbx_ascii_write_node_begin(writer, "PolygonVertexIndex")) return false;
    ...
    for (size_t i = 0; i < scene_imp->num_materials; i++) {
        ...
        if (!ufbx_ascii_write_node_begin(writer, "Material")) return false;
        if (!ufbx_ascii_write_property_i64(writer, material->element.element_id)) return false;
        if (!ufbx_ascii_write_string(writer, ", ")) return false;
        if (!ufbx_ascii_write_property_string(writer, material->element.name.data)) return false;
        if (!ufbx_ascii_write_string(writer, ", ")) return false;
        if (!ufbx_ascii_write_property_string(writer, "")) return false;
        if (!ufbx_ascii_write_string(writer, " {\n")) return false;
        writer->indent_level++;
        ...
        // Version
        if (!ufbx_ascii_write_node_begin(writer, "Version")) return false;
        if (!ufbx_ascii_write_property_i64(writer, 102)) return false;
        if (!ufbx_ascii_write_newline(writer)) return false;
        
        // ShadingModel
        if (!ufbx_ascii_write_node_begin(writer, "ShadingModel")) return false;
        if (!ufbx_ascii_write_property_string(writer, "phong")) return false;
        if (!ufbx_ascii_write_newline(writer)) return false;
        
        // MultiLayer
        if (!ufbx_ascii_write_node_begin(writer, "MultiLayer")) return false;
        if (!ufbx_ascii_write_property_i64(writer, 0)) return false;
        if (!ufbx_ascii_write_newline(writer)) return false;
        ...
        // DiffuseColor
        if (!ufbx_ascii_write_node_begin(writer, "P")) return false;
        if (!ufbx_ascii_write_property_string(writer, "DiffuseColor")) return false;
        if (!ufbx_ascii_write_string(writer, ", ")) return false;
        if (!ufbx_ascii_write_property_string(writer, "Color")) return false;
        if (!ufbx_ascii_write_string(writer, ", ")) return false;
        if (!ufbx_ascii_write_property_string(writer, "")) return false;
        if (!ufbx_ascii_write_string(writer, ", ")) return false;
        if (!ufbx_ascii_write_property_string(writer, "A")) return false;
        if (!ufbx_ascii_write_string(writer, ", ")) return false;
        if (!ufbx_ascii_write_property_f64(writer, material->pbr.base_color.value_vec3.x)) return false;
        if (!ufbx_ascii_write_string(writer, ", ")) return false;
        if (!ufbx_ascii_write_property_f64(writer, material->pbr.base_color.value_vec3.y)) return false;
        if (!ufbx_ascii_write_string(writer, ", ")) return false;
        if (!ufbx_ascii_write_property_f64(writer, material->pbr.base_color.value_vec3.z)) return false;
        if (!ufbx_ascii_write_newline(writer)) return false;
...
static bool ufbx_ascii_write_connections(ufbx_ascii_writer *writer, const ufbx_export_scene *scene) {
    ...
    if (!ufbx_ascii_write_node_begin(writer, "Connections")) return false;
    if (!ufbx_ascii_write_string(writer, "{\n")) return false;
    writer->indent_level++;
    ...
    for (size_t i = 0; i < scene_imp->num_nodes; i++) {
        ...
        if (!node->parent) { // Root level nodes
            if (!ufbx_ascii_write_node_begin(writer, "C")) return false;
            if (!ufbx_ascii_write_property_string(writer, "OO")) return false;
            if (!ufbx_ascii_write_string(writer, ", ")) return false;
            if (!ufbx_ascii_write_property_i64(writer, node->element.element_id)) return false;
            if (!ufbx_ascii_write_string(writer, ", ")) return false;
            if (!ufbx_ascii_write_property_i64(writer, 0)) return false; // Root node ID
            if (!ufbx_ascii_write_newline(writer)) return false;
        } else {
            ...
            if (!ufbx_ascii_write_property_i64(writer, node->element.element_id)) return false;
            if (!ufbx_ascii_write_string(writer, ", ")) return false;
            if (!ufbx_ascii_write_property_i64(writer, node->parent->element.element_id)) return false;
            if (!ufbx_ascii_write_newline(writer)) return false;
        }
        ...
        if (node->mesh) {
            ...
            if (!ufbx_ascii_write_property_string(writer, "OO")) return false;
            if (!ufbx_ascii_write_string(writer, ", ")) return false;
            if (!ufbx_ascii_write_property_i64(writer, node->mesh->element.element_id)) return false;
            if (!ufbx_ascii_write_string(writer, ", ")) return false;
            if (!ufbx_ascii_write_property_i64(writer, node->element.element_id)) return false;
            if (!ufbx_ascii_write_newline(writer)) return false;
        }
    ...
    for (size_t i = 0; i < scene_imp->num_meshes; i++) {
        ...
        if (mesh->materials.count > 0 && mesh->materials.data) {
            ...
            if (!ufbx_ascii_write_property_string(writer, "OO")) return false;
            if (!ufbx_ascii_write_string(writer, ", ")) return false;
            if (!ufbx_ascii_write_property_i64(writer, mesh->materials.data[0]->element.element_id)) return false;
            if (!ufbx_ascii_write_string(writer, ", ")) return false;
            if (!ufbx_ascii_write_property_i64(writer, mesh->element.element_id)) return false;
            if (!ufbx_ascii_write_newline(writer)) return false;
        }
...
// ASCII export implementation functions
static ufbx_error ufbx_ascii_export_to_file_impl(const ufbx_export_scene *scene, const char *filename, 
...
static ufbx_export_result ufbx_ascii_export_to_memory_impl(const ufbx_export_scene *scene, 
                                                          const ufbx_export_opts *opts) {
...
// Main export function implementation with format detection
ufbx_error ufbx_export_to_file_impl(const ufbx_export_scene *scene, const char *filename, 
                                    const ufbx_export_opts *opts) {
    // Check if ASCII format is requested
    if (opts && opts->ascii_format) {
        return ufbx_ascii_export_to_file_impl(scene, filename, opts);
    }
...
ufbx_export_result ufbx_export_to_memory_impl(const ufbx_export_scene *scene, 
    ...
    // Check if ASCII format is requested
    if (opts && opts->ascii_format) {
        return ufbx_ascii_export_to_memory_impl(scene, opts);
    }
